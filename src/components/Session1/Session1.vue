<template>
  <div>
    ...
    <div class="session-container">
      <svg v-visible="page > 1" @click="previous" class="arrow" id="left-arrow" version="1.2" baseProfile="tiny-ps" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 183 183" width="183" height="183">
