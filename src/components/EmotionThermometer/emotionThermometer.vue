<template>
  <div class="emotions-meter-container">
    <div class="thermometer">
      <div class="bar" @click="handleClick" id="fifth"></div>
      <div class="bar" @click="handleClick" id="fourth"></div>
      <div class="bar" @click="handleClick" id="third"></div>
      <div class="bar" @click="handleClick" id="second"></div>
      <div class="bar" @click="handleClick" id="first"></div>
    </div>
...
export default {
  ...
  methods: {
    handleClick(e) {
      ...
      switch (e.target.id) {
        case 'first':
          firstBar.style.backgroundColor = '#23C4FA';
          ...
          fifthBar.style.backgroundColor = 'transparent';
          this.toggleEmotions(document.getElementById('happy'));
          break;
        case 'second':
          firstBar.style.backgroundColor = '#23C4FA';
          secondBar.style.backgroundColor = '#04CA1F';
          thirdBar.style.backgroundColor = 'transparent';
          fourthBar.style.backgroundColor = 'transparent';
          fifthBar.style.backgroundColor = 'transparent';
        ...
        case 'third':
          firstBar.style.backgroundColor = '#23C4FA';
          secondBar.style.backgroundColor = '#04CA1F';
          thirdBar.style.backgroundColor = '#FAE93E';
          fourthBar.style.backgroundColor = 'transparent';
          fifthBar.style.backgroundColor = 'transparent';
        ...
        case 'fourth':
          ...
          secondBar.style.backgroundColor = '#04CA1F';
          thirdBar.style.backgroundColor = '#FAE93E';
          fourthBar.style.backgroundColor = '#F8A41B';
          fifthBar.style.backgroundColor = 'transparent';
        ...
        case 'fifth':
          ...
          thirdBar.style.backgroundColor = '#FAE93E';
          fourthBar.style.backgroundColor = '#F8A41B';
          fifthBar.style.backgroundColor = '#FF0000';
