<template>
  <div class="interactive-container">
    ...
    />
    <div class="text-box">
      <h1 class="mb-5">Try Every Day</h1>
      <p>- Try your step plan one step at a time. </p>
      <p>- You can do it slowly.</p>
      <p>- Stay on each step until you can do that step easily. </p>
      <p>- Ask your family to help you.</p>
      <p>- If any step is hard, take more time to do it.</p>
