<template>
  <div class="interactive-container">
    ...
    <audio @loadeddata="playSoundText" src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/audio/session7/Session7_Page17.mp3" ref="voice"/>
