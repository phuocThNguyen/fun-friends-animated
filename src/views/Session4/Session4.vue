...
export default {
  ...
  data() {
    return {
      pages: {
        1: "Session4Page1", 2: "Session4Page2", 3: "Session4Page3", 4: "Session4Page4", 5: "Session4Page5",
  ...
  methods: {
    previous() {
      if (this.page > 1) {
        ...
        this.$store.commit("setCurrentSession", 3);
      }
    },
    next() {
      if (this.page < this.lastPage) {
        ...
        this.$store.commit("setCurrentSession", 5);
      }
    },
  },
  mounted() {
