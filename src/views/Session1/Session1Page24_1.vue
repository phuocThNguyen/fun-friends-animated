<template>
  <div class="interactive-container">
    ...
    <audio
      ...
      src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/audio/session1/Session1_Page35.mp3" ref="voice"/>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    toggleChoice(id) {
      ...
      this.$store.commit('setPage30_1Data', this.choices);
    },
    setChoiceBackground() {
    ...
    init() {
      this.choices = this.$store.getters.getPage30_1Data;
    },
    playSoundText() {
      this.playVoiceOver();
    }
