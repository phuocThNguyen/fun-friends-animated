  ...
  <div class="interactive-container">
    ...
    <div class="choice-container" id="choice-1">
      <div class="image" @click="toggleChoice(1)">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session1/938-resized.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session1/938-resized.jpg"
    ...
    <div class="choice-container" id="choice-2">
      <div class="image" @click="toggleChoice(2)">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session1/1200-resized.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session1/1200-resized.jpg"
          class="image-component"
        />
      </div>
    </div>
    <div class="choice-container" id="choice-3">
      <div class="image" @click="toggleChoice(3)">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session1/189-resized.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session1/189-resized.jpg"
          class="image-component"
        />
      </div>
    </div>
    ...
    <div class="text-box">
      <p class="text">
        <span>Trying different foods is fun.</span>
      </p>
    </div>
    ...
    <audio
      ...
      src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/audio/session1/35Animated_Book_Page34.mp3" ref="voice"/>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    toggleChoice(id) {
      ...
      this.$store.commit('setPage35Data', this.choices);
    },
    setChoiceBackground() {
    ...
    init() {
      this.choices = this.$store.getters.getPage35Data;
    },
    animateText() {
      anime({
        targets: ".text-box",
