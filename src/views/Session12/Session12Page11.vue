  ...
  <div class="interactive-container">
    <div class="choice-container" id="choice-1" @click="toggleChoice(1)">
      <div class="image-container">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session12/portrait-boy-with-dog.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session12/portrait-boy-with-dog.jpg"
          alt="" class="image" id="image-1"
        />
      </div>
      <div class="text">Playing with your dog</div>
    </div>
    <div class="choice-container" id="choice-2" @click="toggleChoice(2)">
      <div class="image-container">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session12/pexels-hson-10699249.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session12/pexels-hson-10699249.jpg"
          alt="" class="image" id="image-2"
        />
      </div>
      <div class="text">Playing with your cat</div>
    </div>
    <div class="choice-container" id="choice-3" @click="toggleChoice(3)">
      <div class="image-container">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session12/chicken-farm-scene-with-poultry-people.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session12/chicken-farm-scene-with-poultry-people.jpg"
          alt="" class="image" id="image-3"
        />
      </div>
      <div class="text">Playing with your chicken</div>
    </div>
    <div class="choice-container" id="choice-4" @click="toggleChoice(4)">
      <div class="image-container">
        <ImageComponent
          src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/max/session12/farmer-taking-care-goat-farm.jpg"
          srcPlaceholder="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/images/min/session12/farmer-taking-care-goat-farm.jpg"
          alt="" class="image" id="image-4"
        />
      </div>
      <div class="text">Playing with your goat</div>
    </div>
    ...
    <button class="btn-style" @click="revealBalloons">Click here when done</button>
