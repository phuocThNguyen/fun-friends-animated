<template>
  <div class="interactive-container">
    ...
    <audio
      ...
      src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/audio/session3/Session3_Page93%2B1.mp3" ref="voice"/>
...
export default {
  ...
  methods: {
    ...
    animateText() {
      ...
      animation
        ...
        .add({targets: text[2], opacity: 1}, 9100)
        .add({targets: ".question-container", opacity: 1}, 11100)
    },
    playVoiceOver() {
    ...
    init() {
      this.answers = this.$store.getters.getPage96Data;
    },
  },
  created() {
    this.init();
  ...
  watch: {
    answers: function() {
      ...
      this.$store.commit('setPage96Data', this.answers)
    }
  }
}
</script>
