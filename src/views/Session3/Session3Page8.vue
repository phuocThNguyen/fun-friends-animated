<template>
  <div class="interactive-container">
    ...
    />
    <div class="text-box">
      <p><strong>Lily likes helping grandma in the garden.</strong></p>
      <p>How can Lily help her Grandma?</p>
...
export default {
  ...
  data() {
    return {
      data: ['Water the plants','Pick fruit and vegetables',
        'Remove weeds','Plant seeds'],
      answers: [],
    }
  },
  props: {
  ...
  methods: {
    ...
    animateText() {
      ...
      animation
        ...
        .add({targets: text[1], opacity: 1}, 7700)
        .add({targets: text[2], opacity: 1}, 10600)
        .add({targets: ".question-container", opacity: 1}, 12600)
    },
    playVoiceOver() {
  ...
  watch: {
    answers: function() {
      ...
      this.$store.commit('setPage95Data', this.answers)
    }
  }
}
</script>
