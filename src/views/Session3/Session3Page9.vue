<template>
  <div class="interactive-container">
    ...
    />
    <div class="text-box">
      <p>Grandma is coming home after a day out and she is tired.</p>
    ...
    <audio
      ...
      src="https://s3.ap-southeast-2.amazonaws.com/uploads.friendsresilience.org/animatedbook-resources/FF/audio/session3/Session3_Page94.mp3" ref="voice"/>
...
export default {
  ...
  data() {
    return {
      data: ['Cook a meal together','Help her buy groceries',
        'Help her push the wheelchair'],
      answers: [],
    }
  },
  props: {
  ...
  methods: {
    ...
    animateText() {
      ...
      animation
        ...
        .add({targets: ".question-container", opacity: 1}, 9500)
    },
    playVoiceOver() {
    ...
    init() {
      this.answers = this.$store.getters.getPage99Data;
    },
  },
  created() {
    this.init();
  ...
  watch: {
    answers: function() {
      ...
      this.$store.commit('setPage99Data', this.answers)
    }
  }
}
</script>
